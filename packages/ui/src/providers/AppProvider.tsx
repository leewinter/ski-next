...
const THEME_CSS_VARIABLES: Record<AppThemeMode, CSSProperties> = {
  default: {
    ...
    '--ski-next-ski-cal-event-padding': '5px 6px 12px',
    '--ski-next-ski-cal-event-title-size': '11px',
    '--ski-next-ski-cal-event-time-size': '10px',
    '--ski-next-ski-cal-segment-bottom': '5px',
    '--ski-next-ski-cal-segment-height': '3px',
  } as CSSProperties,
  dark: {
  ...
  compact: {
    ...
    '--ski-next-color-overlay-bg': 'rgba(31, 31, 31, 0.94)',
    '--ski-next-color-overlay-text': '#fff',
    '--ski-next-ski-cal-header-size': '54px',
    '--ski-next-ski-cal-event-thickness': '36px',
    '--ski-next-ski-cal-event-gap': '4px',
    '--ski-next-ski-cal-event-padding': '3px 5px 8px',
    '--ski-next-ski-cal-event-title-size': '10px',
    '--ski-next-ski-cal-event-time-size': '9px',
    '--ski-next-ski-cal-segment-bottom': '3px',
    '--ski-next-ski-cal-segment-height': '2px',
  } as CSSProperties,
  skiidy: {
